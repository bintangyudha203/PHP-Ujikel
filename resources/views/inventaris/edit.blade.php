      ...
      <div class="fluid">
        ...
        <div class="panel-body">
          <form action="/inventaris/{$inventaris->id_inventaris}/update" method="POST">
                ...
                <input name="tanggal_register" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Tanggal Register" value="{{$inventaris->tanggal_register}}">
                </div>
